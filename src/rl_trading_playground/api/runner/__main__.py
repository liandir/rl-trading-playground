"""Subprocess entrypoint: ``python -m rl_trading_playground.api.runner <run_id>``.
...
from rl_trading_playground.api.services import provenance
...
if __name__ == "__main__":
    if len(sys.argv) < 2:
        print("usage: python -m rl_trading_playground.api.runner <run_id>", file=sys.stderr)
        sys.exit(2)
